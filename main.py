...
class Generator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.cv1 = nn.ConvTranspose2d(nz, ngf * 8, 4, 1, 0, bias=False)
    ...
    def forward(self, input):
        hidden = F.relu(self.bn1(self.cv1(input)))
...
class Discriminator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.cv0 = nn.Conv2d(nc, ndf, 4, 2, 1, bias=False)
    ...
    def forward(self, input):
        hidden = F.leaky_relu(self.cv0(input), negative_slope=0.2)
